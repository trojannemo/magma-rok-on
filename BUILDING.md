# Building Magma: Rok On Edition from Source
...
git clone https://github.com/trojannemo/magma-rok-on.git
...
Magma\Magma\bin\Debug\

(or `Release` if building Release)

## Step 4: Open Solution
Open `Magma.sln` in Visual Studio.
...
I hope this helps more of you be able to compile and edit Magma: Rok On Edition
